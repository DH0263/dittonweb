...
function KioskAttendance() {
  ...
  const handleScan = async () => {
    ...
    try {
      ...
      // 성공!
      setStatus('success');
      setMessage(`${student.name}님, 출석 완료!`);
      setStudentInfo(student);
      resetAfterDelay();
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            fontWeight: 'bold',
            color: 'white',
            backgroundColor: status === 'scanning' ? '#9ca3af' : getStatusColor(),
            border: 'none',
            borderRadius: '16px',
        ...
        {studentInfo && status === 'success' && (
          <div style={{
            ...
            <div style={{ fontSize: '18px', color: '#6b7280', marginBottom: '8px' }}>학생 정보</div>
            <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#111', marginBottom: '4px' }}>
              {studentInfo.name}
            </div>
